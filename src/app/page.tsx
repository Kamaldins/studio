...
export default function SinglePropertyPage() {
  ...
  const nextMiniGallery = () => {
    ...
    setMiniGalleryIndex((prevIndex) => (prevIndex + 1) % (imageUrls.length - 4));
  };

  const prevMiniGallery = () => {
    if (imageUrls.length <= 5) return;
    setMiniGalleryIndex((prevIndex) => (prevIndex - 1 + (imageUrls.length - 4)) % (imageUrls.length - 4));
  };
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 md:px-8 space-y-12">
      ...
      <section id="par" className="space-y-12 py-12 px-4">
        <h2 className="font-headline text-4xl font-bold text-center text-slate-100">Kas jūs sagaida</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-lg max-w-4xl mx-auto text-slate-300">
            <div className="space-y-4">
                <h3 className="font-headline text-2xl font-bold mb-4 text-slate-100">Mājā pieejams</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-headline text-2xl font-bold mb-4 text-slate-100">Āra aktivitātes</h3>
                 <ul className="space-y-3">
        ...
        <div className="text-center bg-slate-800 p-6 rounded-2xl shadow-lg max-w-2xl mx-auto border border-slate-700">
            <h3 className="font-headline text-2xl font-bold text-slate-100">Atrašanās vieta</h3>
            <p className="mt-2 text-slate-400 text-lg">Daugavas kreisajā krastā pie Ķeguma HES</p>
        </div>
      ...
      <section id="cenas" className="py-12 px-4">
          <h2 className="font-headline text-3xl font-bold text-center mb-12 text-slate-100">Izcenojums</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
              <div className="bg-slate-800 p-8 rounded-2xl shadow-lg text-center border border-slate-700">
                  ...
                  <h3 className="font-headline text-xl font-bold text-blue-400 mb-2">Brīvdienu māja</h3>
                  <p className="text-4xl font-black text-slate-100 my-2">200€</p>
                  <p className="text-slate-400">Par nakti (pirts iekļauta cenā)</p>
              </div>
              <div className="bg-slate-800 p-8 rounded-2xl shadow-lg text-center border border-slate-700">
                  <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-900/30">
                  ...
                  <h3 className="font-headline text-xl font-bold text-blue-400 mb-2">Hidromasāžas kubls</h3>
                  <p className="text-4xl font-black text-slate-100 my-2">50€</p>
                  <p className="text-slate-400">Par izmantošanu</p>
              </div>
          </div>
      </section>
      ...
      <section id="objekti" className="py-12 px-4">
         <h2 className="font-headline text-4xl font-bold text-center mb-8 text-slate-100">Atrašanās vieta</h2>
         <MapSection />
      </section>
