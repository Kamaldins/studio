  ...
  return (
    <div>
      <div className="rounded-lg overflow-hidden shadow-lg border mb-8">
        <iframe
          src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2233.5!2d${MEZLICI_LNG}!3d${MEZLICI_LAT}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2z${encodeURIComponent(`${MEZLICI_LAT}°N ${MEZLICI_LNG}°E`)}!5e0!3m2!1slv!2slv!4v1735740000000!5m2!1slv!2slv&q=${encodeURIComponent(MEZLICI_ADDRESS)}`}
          width="100%"
          height="450"
          style={{ border: 0 }}
          allowFullScreen
