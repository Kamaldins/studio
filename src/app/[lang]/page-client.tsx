  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 md:px-8 space-y-12">
      ...
      <section id="par" className="space-y-12 py-12 px-4">
        <h2 className="font-headline text-4xl font-bold text-center">{dictionary.about.title}</h2>
      ...
      <section id="cenas" className="py-12 px-4">
        <h2 className="font-headline text-3xl font-bold text-center mb-12">{dictionary.pricing.title}</h2>
      ...
      <section id="objekti" className="py-12 px-4">
        <h2 className="font-headline text-4xl font-bold text-center mb-8">{dictionary.map.title}</h2>
        <MapSection />
      </section>
